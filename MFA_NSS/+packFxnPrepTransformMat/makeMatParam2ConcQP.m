%% Make transformation matrix (param -> concQP)
function matParam2ConcQP = ...
...
switch inputFlag
    ...
    case {21,22}
        ...
        matConcConstRate2ConcQP = ...
            makeMatConcConstRate2Conc(model, expData, optionsMFA, fullSwitchTimes, timeConstrQP, idNonPoolMets);
        matParam2ConcQP = matConcConstRate2ConcQP * [matParam2ConcConst;matParam2ConcRate];
end
